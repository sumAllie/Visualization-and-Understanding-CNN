...
caffevis_deploy_prototxt = '%DVT_ROOT%/models/alexnet/alexnet-deploy.prototxt'

# Path to network weights to load.
caffevis_network_weights = '%DVT_ROOT%/models/alexnet/bvlc_alexnet.caffemodel'

# Other optional settings; see complete documentation for each in settings.py.
caffevis_data_mean       = (104, 117, 123)  
caffevis_labels          = '%DVT_ROOT%/models/alexnet/ilsvrc_2012_labels.txt'
caffevis_label_layers    = ('fc8', 'prob')
caffevis_prob_layer      = 'prob'
caffevis_unit_jpg_dir    = '%DVT_ROOT%/models/alexnet/unit_jpg_vis'
